    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (true) {
            ...
            if (metric.datasource.type === 'influxdb') {
                chunkParams.q = query;
                chunk = yield queryGrafana(url, apiKey, chunkParams, metric);
            }
            else if (metric.datasource.type === 'graphite') {
                chunk = yield queryGrafana(`${url}/${query}`, apiKey, chunkParams, metric);
            }
...
function queryGrafana(url, apiKey, params, metric) {
    return __awaiter(this, void 0, void 0, function* () {
        let headers = { Authorization: `Bearer ${apiKey}` };
        try {
            var res = yield axios_1.default.get(url, { params, headers });
        }
        catch (e) {
